        ...
        <div className="absolute inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50">
            <div className="flex flex-col w-full p-20 m-8 bg-white rounded-md lg:m-0 sm:p-10 max-w-[500px]">
                <div className="mb-8 text-center">
                    ...
                    <p className="text-sm text-coolGray-600">{isRegistering ? "Sign up to create an account" : "Sign in to access your account"} </p>
                </div>
                <form action="" className="">
                    ...
                    <div className="mt-6 space-y-2">
                        <div className="flex gap-x-2">
                            <button onClick={loginPress} type="button"
                                    className="w-full px-8 py-3 text-blue-100 bg-blue-600 rounded-md">
                                {isRegistering ? "Sign up" : "Sign in"}
                            </button>
                        </div>
                        <p className="px-6 text-sm text-center text-coolGray-600">{isRegistering ? "Already have an account?" : "Don't have an account yet?"}
                            <button onClick={() => setIsRegistering(!isRegistering)}
                                    className="text-blue-600 hover:underline ml-1">{isRegistering ? "Sign in" : "Sign up"}</button>
                            .
                        </p>
                    </div>
                </form>
